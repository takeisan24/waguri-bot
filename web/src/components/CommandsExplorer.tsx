...
const CATEGORIES_VI: Cat[] = [
  {
    ...
    cmds: [
      ...
      ["worldevent", "sự kiện thế giới: đóng góp tài nguyên nhận quà co-op 🌍"],
...
const CATEGORIES_EN: Cat[] = [
  {
    ...
    cmds: [
      ...
      ["worldevent", "world events: contribute resources for co-op rewards 🌍"],
  ...
  },
  {
    ...
    cmds: [
      ...
      ["study", "Pomodoro study companion 24/7 with Waguri (start · status · stop · leaderboard · shop) 📚"],
    ],
  },
  {
  ...
  },
  {
    ...
    cmds: [
      ...
      ["antinuke", "anti-nuke: stop mass channel/role deletion & ban waves 🛡️ (owner)"],
