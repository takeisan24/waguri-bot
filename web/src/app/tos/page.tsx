...
export async function generateMetadata() {
  ...
  return {
    title: `${locale === "en" ? "Terms of Service" : "Điều Khoản Dịch Vụ"} — Waguri`,
    robots: { index: true },
  };
}
          ...
          {locale === "en" ? (
            ...
            <>
              ...
              <div className="space-y-6 text-sm md:text-base leading-relaxed text-slate-300">
                <p>
                   Welcome to <strong>Waguri Discord Bot</strong> (hereinafter referred to as the &quot;Bot&quot;). By inviting the Bot to your server or interacting with the Bot&apos;s services, you agree to comply with and be bound by the Terms of Service below. If you do not agree to any part of these terms, please stop using the Bot.
                </p>

                <section className="space-y-3">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <span className="text-pink-300">1.</span> <span>Virtual Economy and Items</span>
                  </h2>
                  <ul className="list-disc pl-5 space-y-2 text-slate-400 text-sm">
                    <li>All virtual currency (VND), energy (⚡), equipment, items, or assets accumulated in the Waguri system are purely virtual.</li>
                    <li>They have no real-world cash value and cannot be redeemed, transferred, or traded for real-world currency or life transactions under any circumstances.</li>
                    <li>Any trading of virtual accounts or assets in the Bot for real money will result in strict penalties (including permanent bans and database resets).</li>
                  </ul>
                </section>

                <section className="space-y-3">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <span className="text-pink-300">2.</span> <span>Usage Rules & Prohibited Behaviors</span>
                  </h2>
                  <p className="text-sm">We aim to build a healthy and fair community. You agree not to engage in:</p>
                  <ul className="list-disc pl-5 space-y-2 text-slate-400 text-sm">
                    <li>Exploiting, spamming commands, or using automated software (botting/self-bot) to farm virtual coins or interact with the system.</li>
                    <li>Exploiting bugs or vulnerabilities for profit. Users who find bugs are expected to report them to the development team instead of exploiting them.</li>
                    <li>Using the Bot to harass others or violate Discord Terms of Service.</li>
                  </ul>
                  <p className="text-xs text-rose-300 bg-rose-500/5 border border-rose-500/10 p-3 rounded-lg">
                    ⚠️ <strong>Penalties:</strong> Any violation may result in command restrictions, asset confiscation, or a permanent ban from the Bot without prior notice.
                  </p>
                </section>

                <section className="space-y-3">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <span className="text-pink-300">3.</span> <span>Disclaimer of Liability</span>
                  </h2>
                  <ul className="list-disc pl-5 space-y-2 text-slate-400 text-sm">
                    <li>The Bot is provided &quot;as is&quot; and &quot;as available&quot;. We do not guarantee that the Bot will operate 100% continuously or error-free.</li>
                    <li>We are not liable for any loss of virtual data (e.g., lost virtual coins, levels, or items) due to database failures, network issues, or unauthorized third-party actions.</li>
                     <li>The AI chat feature (powered by Google Gemini API) is strictly for entertainment. AI answers are machine-generated and do not represent the developer&apos;s views.</li>
                  </ul>
                </section>

                <section className="space-y-3">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <span className="text-pink-300">4.</span> <span>Web Accounts & Dashboard</span>
                  </h2>
                  <ul className="list-disc pl-5 space-y-2 text-slate-400 text-sm">
                    <li>You can log in to the website using your Discord account to view your personal dashboard. You are responsible for keeping your session secure.</li>
                     <li>The dashboard only displays your own game data; attempting to access other users&apos; data unauthorized is strictly prohibited.</li>
                    <li>Public profiles (/u/...) display some of your game stats; you can hide your profile anytime in settings.</li>
                  </ul>
                </section>

                <section className="space-y-3">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <span className="text-pink-300">5.</span> <span>Changes to Terms</span>
                  </h2>
                  <p className="text-slate-400 text-sm">
                    We reserve the right to modify these Terms of Service at any time. Changes will take effect immediately upon posting on this website. Your continued use of the Bot means you accept the new terms.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-slate-400 text-sm">
                    If you have any questions, complaints, or want to report bugs/cheating, please contact us at:
                  </p>
