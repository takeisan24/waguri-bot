...
test('Sprint 3: Vehicle selection priority logic (xe energy thấp nhất đang sở hữu)', () => {
    ...
    assert.strictEqual(getBestVehicle([{ item_id: 'xe_wave' }, { item_id: 'xe_sh' }]), 'xe_sh');
    assert.strictEqual(getBestVehicle([{ item_id: 'xe_wave' }, { item_id: 'o_to_vinfast' }, { item_id: 'xe_sh' }]), 'o_to_vinfast');
