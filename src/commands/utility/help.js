...
const CATEGORIES = [
    { name: '💼 Kinh tế & Nghề', cmds: [
        ...
        ['quest', 'nhiệm vụ hằng ngày & cốt truyện (thưởng tiền)'],
        ...
        ['relief', 'nhận trợ cấp phá sản khi ví và ngân hàng hết sạch 🌸'],
    ] },
    { name: '🏪 Cửa hàng & Kho', cmds: [
        ...
        ['rest', 'đi ngủ hồi đầy năng lượng (6 tiếng/lần) 😴 (w!ngu)'],
    ...
    { name: '🎲 Nuôi trồng & Tiệm bánh', cmds: [
        ['farm', 'nông trại Kikyo 🌱 (info · plant · water · harvest · steal)'],
        ['bakery', 'tiệm bánh Gekka 🍰 (kinh doanh thụ động: xem · mo · nhapnl · thu · nangcap · donhang · giaodon)'],
    ...
    { name: '🎀 Vui & Cộng đồng', cmds: [
        ['trivia', 'đố vui 🧠 (trả lời nhanh trong chat, thắng thưởng)'],
        ['wordchain', 'chơi nối từ tiếng Việt 🔤'],
        ['fortune', 'xem bói: hằng ngày / cung hoàng đạo / thầy đồ 🔮'],
        ['lunar', 'xem âm lịch, can-chi, giờ hoàng đạo + lời Waguri 🌙'],
    ...
    { name: '🏆 Khác', cmds: [
        ...
        ['ticket', 'mở form góp ý & hỗ trợ trực tiếp tới đội ngũ 🌸'],
