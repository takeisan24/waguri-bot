...
module.exports = {
    ...
    BAKERY: {
        ...
        // Giờ cao điểm tiệm bánh (UTC+7: 11h-13h và 18h-20h)
        RUSH_HOUR: {
            WINDOWS: [
                { startHourVN: 11, endHourVN: 13 },
                { startHourVN: 18, endHourVN: 20 },
            ],
            BONUS_RATE: 0.20, // +20% tốc độ nướng trong giờ cao điểm
        },
        // Pool Đơn Hàng VIP Khách Quen
        VIP_ORDERS_POOL: [
            {
                id: 'kaoruko_picnic',
                customer: '🌸 Tiểu Thư Kaoruko',
                titleVi: 'Tiệc Trà Hoa Dã Ngoại',
                titleEn: 'Floral Picnic Tea Party',
                descVi: 'Bánh su kem cùng trái cây tươi ngon cho buổi sinh hoạt dã ngoại.',
                descEn: 'Cream puffs and fine fresh fruits for an outdoor club picnic.',
                required: { banh_su_kem: 2, trai_2500: 2 },
                rewardCoins: 15000,
                rewardExp: 100,
                rewardRep: 10,
                cakeProgress: 2000,
            ...
            {
                id: 'rintaro_stock',
                customer: '🧑‍🍳 Bếp Trưởng Rintaro',
                titleVi: 'Mẻ Bánh Mới Của Bếp Trưởng',
                titleEn: "Head Chef's New Batch",
                descVi: 'Bột mì, đường tinh luyện cùng hoa thơm để tạo men bánh mới.',
                descEn: 'Flour, sugar and fragrant flowers to formulate a new pastry yeast.',
                required: { bot_mi: 4, hoa_2000: 2, duong: 2 },
                rewardCoins: 12000,
                rewardExp: 80,
                rewardRep: 8,
                cakeProgress: 1500,
            ...
            {
                id: 'subaru_council',
                customer: '👓 Hội Trưởng Subaru',
                titleVi: 'Trực Nhật Hội Học Sinh',
                titleEn: 'Student Council Duty',
                descVi: 'Bánh flan mềm mịn kèm hoa thơm hảo hạng giúp giải tỏa căng thẳng sau giờ học.',
                descEn: 'Caramel flan and premium flowers to relieve stress after school.',
                required: { banh_flan: 2, hoa_3500: 1 },
                rewardCoins: 22000,
                rewardExp: 150,
                rewardRep: 15,
                cakeProgress: 3000,
            ...
            {
                id: 'madoka_archery',
                customer: '🎯 Đoàn Bắn Cung Madoka',
                titleVi: 'Bữa Phụ Tiếp Sức Thi Đấu',
                titleEn: 'Archery Team Energy Fuel',
                descVi: 'Bánh mì kẹp thịt heo bồi bổ thể lực cho các tuyển thủ bắn cung trước vòng chung kết.',
                descEn: 'Pork sandwiches providing energy for archery contenders before the finals.',
                required: { thit_heo_2500: 2, banh_mi: 2 },
                rewardCoins: 18000,
                rewardExp: 120,
                rewardRep: 12,
                cakeProgress: 2500,
            ...
            {
                id: 'kikyo_prof',
                customer: '📚 Giáo Sư Học Viện Kikyo',
                titleVi: 'Hội Thảo Trà Chiều Học Thuật',
                titleEn: 'Academic Afternoon Tea Seminar',
                descVi: 'Bánh su kem và trà thơm phục vụ buổi bảo vệ luận văn danh dự.',
                descEn: 'Cream puffs and fragrant flowers served for the honors dissertation defense.',
                required: { banh_su_kem: 3, hoa_2000: 3 },
                rewardCoins: 20000,
                rewardExp: 140,
                rewardRep: 14,
                cakeProgress: 2800,
            ...
            {
                id: 'royal_gourmet',
                customer: '🚢 Thực Khách Sành Ăn',
                titleVi: 'Bánh Cá Thượng Hạng',
                titleEn: 'Royal Fish Pastry Feast',
                descVi: 'Đặc sản bánh cá kết hợp cá tươi hảo hạng và bột mì thượng phẩm.',
                descEn: 'Signature savory fish pastry combining fresh fish and prime flour.',
                required: { ca_tuoi: 4, bot_mi: 4, trung: 2 },
                rewardCoins: 25000,
                rewardExp: 160,
                rewardRep: 16,
                cakeProgress: 3500,
            ...
            {
                id: 'hoshina_banquet',
                customer: '💎 Gia Tộc Hoshina',
                titleVi: 'Yến Tiệc Quý Tộc Gekka',
                titleEn: 'Noble Gekka Evening Banquet',
                descVi: 'Tráng miệng đẳng cấp: Bánh Kem Dâu Gekka kết hợp bánh flan thượng phẩm.',
                descEn: 'Elite dessert: Gekka Strawberry Cake paired with caramel flan.',
                required: { banh_kem_dau: 1, banh_flan: 1 },
                rewardCoins: 38000,
                rewardExp: 250,
                rewardRep: 25,
                cakeProgress: 5000,
            ...
            {
                id: 'usami_treat',
                customer: '😆 Shohei Usami',
                titleVi: 'Bữa Tiệc Ăn Mừng CLB',
                titleEn: 'Club Victory Celebration',
                descVi: 'Bánh mì giòn rụm và thịt heo cho buổi liên hoan chiến thắng của cả nhóm!',
                descEn: 'Crispy bread and savory pork for the club victory party!',
                required: { banh_mi: 3, thit_heo_2000: 2 },
                rewardCoins: 16000,
                rewardExp: 110,
                rewardRep: 11,
                cakeProgress: 2200,
